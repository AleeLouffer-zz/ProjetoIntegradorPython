...
urlpatterns = [
    path('criar_funcionario', views_tela_inicial.criar_funcionario, name="criar_funcionario"),
    path('criar_servico', views_tela_inicial.criar_servico, name="criar_servico"),
    ...
    path('criar_cliente', views_tela_inicial.criar_cliente, name="criar_cliente"),
